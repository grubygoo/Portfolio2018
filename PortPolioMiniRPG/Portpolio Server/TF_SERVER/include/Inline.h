...
{
inline bool InMySight(const XMFLOAT3& me, const XMFLOAT3& other, BYTE distance) { return  Vector3::Length(Vector3::Subtract(me, other)) <= distance; }
inline bool IsNPC(short id) { return id >= NPC_START; }
}
