...
int DrawGLScene(GLvoid)									// Here's Where We Do All The Drawing
{
	...
	for (int i = 0; i < MAX_USER; ++i)
	{
		...
		/*	if(x > 700 && x!=0 && y!=0)
			printf("X:%d Y:%d\n", x, y);*/
		x1 = (float)(x - 500) * 0.0007f;
		y1 = (float)(y - 500) * -0.0007f;
		//x1 = (-0.8 + x / 40.0);
		//y1 = (0.60 - y / 40.0);
		z1 = -1.0f;
		glVertex3f(x1, y1, z1);
	}
	//x1 = (float)(-0.4) ;//0,0 =-0.4,0.4
	//y1 = (float)(0.4) ;
	//z1 = -1.0f;
	/*glVertex3f(x1, y1, z1);*/
	...
	//{
	//	getpos(i, &x, &y, &cuser);
	//	x1 = (float)(x - 500) * 0.00025f;
	//	y1 = (float)(y - 500) * 0.00025f;
	//	z1 = -1.0f;
	//	glVertex3f(x1, y1, z1);
	//}
	...
	int			nCmdShow)			// Window Show State
{
	...
	if (!CreateGLWindow(L"NeHe's Bitmap Font Tutorial", 1000, 1000, 16, fullscreen))
	{
