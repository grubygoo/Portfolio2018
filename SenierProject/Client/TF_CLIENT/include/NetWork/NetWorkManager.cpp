...
void CNetWorkManager::SendStartPacket()
{
...
void CNetWorkManager::SendSkillPacket(CPlayer & player)
{
	cs_packet_skill Packet;
	Packet.size = sizeof(cs_packet_skill);
...
void CNetWorkManager::SendTelePortPacket(CPlayer & player)
{
