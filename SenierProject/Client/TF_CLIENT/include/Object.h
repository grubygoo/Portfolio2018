...
public:	
	...
	virtual void  Update(float fDeltaTime, XMFLOAT4X4 worldmtx);
...
public:
	virtual bool Initialize(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, void *pContext = NULL);
	void Animate(float fTimeElapsed, CCamera *pCamera);
	void SetLookAt(XMFLOAT3& xmf3Target, XMFLOAT3 right);
	void SetLookAt2(XMFLOAT4X4& tartget);
	virtual void  Render(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera, UINT nInstances = 1);
};

class CChangeEffect : public CGameObject
{
public:
	float etime = 0;
	bool isOn = false;
...
class CFairyEffect : public CGameObject
{
public:
	float etime = 0;
	bool isOn = false;
...
class CTeleportEffect : public CGameObject
{
public:
	float etime = 0;
	float skilltime = 0;
...
class CWarriorSkillEffect : public CGameObject
{
public:
	float etime = 0;
	float skilltime = 0;
...
class CFairySkillEffect : public CGameObject
{
public:
	float etime = 0;
	float skilltime = 0;
...
class CSanyangSkillEffect : public CGameObject
{
public:
	float etime = 0;
	float skilltime = 0;
