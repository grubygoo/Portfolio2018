...
void CSceneManager::Update(float fDeltaTime, ID3D12Device * pd3dDevice, ID3D12GraphicsCommandList * pd3dCommandList)
{
	if (!nextState)
	{
...
void CSceneManager::EffectUpdate(ID3D12Device * pd3dDevice, ID3D12GraphicsCommandList * pd3dCommandList)
{
	if (!nextState)
